  ...
  onLeave: function(index, nextIndex, direction) {
   ...
   afterRender: function() {
    ...
    $("#btnFrutta").click(function() {
      ...
      doveSono = $(this);
   //   banneroneFrutta.to(0); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#btnOlio").click(function() {
      ...
      $(this).addClass("scrittaAttiva");
      doveSono = $(this);
      //banneroneFrutta.to(1); TODO: Qui ci deve andare il cambio di immagine
    ...
    //  banneroneFrutta.to(2); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#btnOrtaggi").click(function() {
      ...
      doveSono = $(this);
      doveSono.addClass("scrittaAttiva");
    //  banneroneFrutta.to(3); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#terraDelleRose").click(function() {
      ...
      //banneroneProduttori.to(0); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#boscoFicuzza").click(function() {
      ...
      doveSono2 = $(this);
      doveSono2.addClass("scrittaAttiva");
     // banneroneProduttori.to(1); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#verdureGrigliate").click(function() {
     ...
     // banneroneTrasformati.to(0); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#leComposte").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
     // banneroneTrasformati.to(1); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#iPate").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
     // banneroneTrasformati.to(2); TODO: Qui ci deve andare il cambio di immagine
    ...
    $("#sugoOlive").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
    //  banneroneTrasformati.to(3); TODO: Qui ci deve andare il cambio di immagine
