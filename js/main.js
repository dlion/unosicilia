  ...
  onLeave: function(index, nextIndex, direction) {
   ...
   afterRender: function() {
    ...
    $("#btnFrutta").click(function() {
      ...
      doveSono = $(this);
      $("#ImmagineSection1").attr("src","./materiale/TRASFORMATI/FRUTTA.png");
    ...
    $("#btnOlio").click(function() {
      ...
      $(this).addClass("scrittaAttiva");
      doveSono = $(this);
      $("#ImmagineSection1").attr("src","./materiale/TRASFORMATI/OLIVE_OLIO.png");
    ...
    $("#btnAgrumi").click(function() {
      ...
      $("#ImmagineSection1").attr("src","./materiale/TRASFORMATI/AGRUMI.png");
    ...
    $("#btnOrtaggi").click(function() {
      ...
      doveSono = $(this);
      doveSono.addClass("scrittaAttiva");
      $("#ImmagineSection1").attr("src","./materiale/TRASFORMATI/ORTAGGI.png");
    ...
    $("#terraDelleRose").click(function() {
      ...
      $("#ImmagineSection2").attr("src","./materiale/TRASFORMATI/TERRA_DELLE_ROSE.png");
    ...
    $("#boscoFicuzza").click(function() {
      ...
      doveSono2 = $(this);
      doveSono2.addClass("scrittaAttiva");
      $("#ImmagineSection2").attr("src","./materiale/TRASFORMATI/BOSCO_FICUZZA.png");
    ...
    $("#verdureGrigliate").click(function() {
      ...
      $("#ImmagineSection3").attr("src","./materiale/TRASFORMATI/GRIGLIATI.png");
    ...
    $("#leComposte").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
      $("#ImmagineSection3").attr("src","./materiale/TRASFORMATI/COMPOSTE.png");
    ...
    $("#iPate").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
      $("#ImmagineSection3").attr("src","./materiale/TRASFORMATI/PATE.png");
    ...
    $("#sugoOlive").click(function() {
      ...
      doveSono3 = $(this);
      doveSono3.addClass("scrittaAttiva");
      $("#ImmagineSection3").attr("src","./materiale/TRASFORMATI/SUGO_OLIVE.png");
